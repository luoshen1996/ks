...
*/
var res = 'http://43.128.48.242:38237/ksjsbjk.json';//json填写
var res1 = 'http://43.128.48.242:38237/ks.json';//助力填写
const $$ = Envcc('');
...
try {
  ...
  async ["helpPackage"](T, c) {
    let C = {
      ...
      'body': "{\"fid\":\"890\",\"cc\":\"share_wxms\",\"followRefer\":\"11\",\"code\":\"" + T + "\",\"shareMethod\":\"TOKEN\",\"kpn\":\"NEBULA\",\"subBiz\":\"BARGAIN\",\"shareId\":\"169083\",\"shareMode\":\"SYSTEM\",\"noBackNavi\":\"true\",\"originShareId\":\"16905483\",\"useMerchantWeb\":\"1\",\"layoutType\":\"4\",\"shareObjectId\":" + JSON["stringify"]("{\"teamId\":\"\",\"packetId\":\"" + c + "\"}") + ",\"shareUrlOpened\":\"0\",\"hyId\":\"bargain\",\"timestamp\":" + +new Date() + ",\"pageCode\":1,\"adamA\":0,\"adamB\":0}",
      'headers': {
        ...
        'Referer': "https://ug-fission.kuaishou.com/bargain/?fid=8&cc=share_wxms&followRefer=151&code=" + T + "&shareMethod=TOKEN&kpn=NEBULA&subBiz=BARGAIN&shareId=1690583&shareMode=SYSTEM&noBackNavi=true&originShareId=164083&useMerchantWeb=1&layoutType=4&shareObjectId=%7B%22teamId%22%3A%22%22,%22packetId%22%3A%22" + c + "%22%7D&shareUrlOpened=0&hyId=bargain&timestamp=" + +new Date(),
